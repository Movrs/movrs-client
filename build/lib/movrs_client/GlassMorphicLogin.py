...
class GlassMorphicLogin(QWidget):
    def __init__(self, email=None, password=None, version=None):
        super().__init__()
        self.version = version
        self.initUI(email=email, password=password)

    def initUI(self, email=None, password=None):
    ...
    def on_login_finished(self, success):
        ...
        if success:
            ...
            self.hide()
            self.control_panel = ControlPanel(self, version=self.version)
